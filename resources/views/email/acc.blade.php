				...
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr style="line-height: 25px;">
						<td style="text-align: center;"><strong>Hallo, {{ $engagement->name }}</strong><br>
							Terima Kasih telah menggunakan NRU, reservasi anda dengan kode booking <strong>{{ $engagement->code }}</strong> telah kami terima. Kami akan menuju anda pada tanggal dan waktu yang anda tentukan.
						</td>
					</tr>
					<tr height="30px">
						<td style="text-align: center;">
							<h3><strong style="color: #de2537;">DITERIMA</strong></h3>
						</td>
					</tr>
					<tr>
						<td style="text-align: center;">
