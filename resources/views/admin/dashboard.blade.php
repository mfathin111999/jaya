    ...
    <div class="container-fluid" style="margin-top: 60px;" id="dashboard_id" v-cloak>
      <div class="row">
        ...
        <main role="main" class="col-lg-10 px-4">
          ...
          <div class="row">
            <div class="col-12">
            <h1 class="h5 font-weight-bold">STATISTIK BULAN @{{ umonth }}</h1>
            </div>
              ...
              <div class="card shadow-sm">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-9 align-items-center">
                      <label class="h6 font-weight-bold">Prediksi Pendapatan Maret</label><br>
              ...
              <div class="card shadow-sm">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-9 align-items-center">
                      <label class="h6 font-weight-bold">Pendapatan Maret</label><br>
  ...
  @section('sec-js')
      ...
      <script type="text/javascript">
          var dashboard = new Vue({
            ...
            data : {
              data : [],
              vmonth : moment().format('MM'),
              umonth : '',
              lmonth : '',
            },
            mounted: function () {
              this.getData();
              this.monthName(this.vmonth);
            },
            methods: {
              async getData (){
                await axios.get('api/resource/getMaterialDashboard').then(response => {
